...
const UsuarioSchema: Schema<IUsuarioModel> = new Schema(
  {
    ...
    email: {
      ...
      validate: {
        ...
        message: (props: { value: string }) => `'${props.value}' no es un formato de email válido`,
      },
    },
    password: {
      type: String,
...
const Usuario = mongoose.model<IUsuarioModel, mongoose.PaginateModel<IUsuarioModel>>(
  'Usuario',
  UsuarioSchema,
);
