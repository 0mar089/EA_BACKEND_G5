...
const getBugReport = async (req: Request, res: Response) => {
  ...
  try {
    const bug = await BugReportService.getBugReport(bugId);
...
const getAllBugReports = async (req: Request, res: Response) => {
  try {
    ...
    const bugs = await BugReportService.getAllBugReports(
      page,
      limit,
      estado,
      plataforma,
...
const updateStatus = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const updated = await BugReportService.updateBugReportStatus(bugId, estado);
...
const deleteBugReport = async (req: Request, res: Response) => {
  ...
  try {
    const deleted = await BugReportService.deleteBugReport(bugId);
