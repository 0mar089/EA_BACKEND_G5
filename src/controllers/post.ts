...
const getPost = async (req: AuthRequest, res: Response, next: NextFunction) => {
  ...
  try {
    ...
    const post = await PostService.getPost(postId, requesterId, isAdmin);
...
const deletePost = async (req: AuthRequest, res: Response) => {
  ...
  try {
    const post = await PostService.deletePost(postId, user.id, user.rol);
...
const getSavedPosts = async (req: AuthRequest, res: Response) => {
  try {
    ...
    const posts = await PostService.getSavedPosts(req.user.id, page, limit);
